...
import { BaseNode, isDisjoint, isEquality } from "./compose.ts"
...
export class PredicateNode<domain extends Domain = Domain> extends BaseNode<
    Branch<domain>[]
> {
    compare(predicate: PredicateNode) {
