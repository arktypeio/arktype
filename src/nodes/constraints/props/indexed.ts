...
import { nonVariadicArrayIndexTypeNode, typeNodeFromInput } from "../../type.js"
...
export const getStringNode = cached(() =>
    typeNodeFromInput({ basis: "string" })
)
...
export const arrayIndexTypeNode = (firstVariadicIndex = 0) =>
    firstVariadicIndex === 0
        ...
        : typeNodeFromInput(arrayIndexInput(firstVariadicIndex))
