...
import type { Type, UnionBranches } from "./attributes.js"
import { compress, difference } from "./operations.js"
import { queryAttribute } from "./query.js"

export const compile = (attributes: Type, scope: ScopeRoot): Type => {
    return attributes
