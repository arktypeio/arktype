...
import { HighlightedCode } from "../../../components/code-snippets/Code.tsx"

## Installation

<Tabs>
	<Tab value="pnpm">
		<HighlightedCode lang="bash" code="pnpm install arktype" />
	</Tab>
	<Tab value="npm">
		<HighlightedCode lang="bash" code="npm install arktype" />
	</Tab>
	<Tab value="yarn">
		<HighlightedCode lang="bash" code="yarn install arktype" />
	</Tab>
	<Tab value="bun">
		<HighlightedCode lang="bash" code="bun install arktype" />
	</Tab>
</Tabs>
