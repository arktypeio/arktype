...
<Tabs>
	<Tab value="pnpm">
		<CodeBlock lang="bash" contents="pnpm install arktype" />
	</Tab>
	<Tab value="npm">
		<CodeBlock lang="bash" contents="npm install arktype" />
	</Tab>
	<Tab value="yarn">
		<CodeBlock lang="bash" contents="yarn install arktype" />
	</Tab>
	<Tab value="bun">
		<CodeBlock lang="bash" contents="bun install arktype" />
	</Tab>
</Tabs>
