...
## As a type guard / Rust `matches!` equivalent

If you just want to use your ArkType type as a type guard that returns a boolean, you can use [`.allows`](/type-api#:~:text=be%20accessed%20directly-,allows,-check%20input%20without) instead
