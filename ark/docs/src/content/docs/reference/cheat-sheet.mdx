...
const dateFormattedString = type("string.date")
const isoFormattedString = type("string.date.iso")
const transformStringToDate = type("string.date.parse")
```
	</SyntaxTab>
...
const date = type.ark.Date
//`.root` gets the base type of a subtyped module
const dateFormattedString = type.ark.string.date.root
const isoFormattedString = type.ark.string.date.iso.root
const transformStringToDate = type.ark.string.date.parse
```
