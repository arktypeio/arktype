...
If you're using a different editor, we'd love [help adding support](https://github.com/arktypeio/arktype/issues/989), and in the meantime, don't worry- ArkType still offers best-in-class DX anywhere TypeScript is supported.
