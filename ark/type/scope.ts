...
export type ParseContext = {
	...
	path: string[]
	scope: Scope
	args: Record<string, UnionNode> | undefined
}

type MergedResolutions = Record<string, UnionNode | Generic>
...
export class Scope<r extends Resolutions = any> {
	...
	private parseCache: Record<string, UnionNode> = {}
	...
	parse(def: unknown, ctx: ParseContext): UnionNode {
	...
	maybeResolve(name: string): UnionNode | Generic | undefined {
	...
	maybeResolveNode(name: string): UnionNode | undefined {
