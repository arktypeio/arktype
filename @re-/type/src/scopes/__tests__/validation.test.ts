...
`)
    ...
    test("validates deep objects", () => {
        ...
        assert(recursive.dejaVu.check(dejaVu).errors?.summary).snap(
            ` must be a non-array object (was non-object)`
        )
    })
})
