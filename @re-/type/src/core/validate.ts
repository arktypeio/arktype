...
import { createTraversalContext, TraversalContext } from "./traverse.js"
...
export const createArgs = (
    ...
    const args = {
        ...
        ctx: createTraversalContext(modelOptions) as Context,
        cfg: options
    }
...
export type Context = TraversalContext<Options> & {
