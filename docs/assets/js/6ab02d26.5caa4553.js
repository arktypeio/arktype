    ...
    [98],
    {
        ...
        9003: (t, e, r) => {
            ...
            const m = { sidebar_position: 6 },
                d = "Congratulations!",
                f = {
                    unversionedId: "test/tutorial-basics/congratulations",
                    id: "test/tutorial-basics/congratulations",
                    title: "Congratulations!",
                    description:
                        "You have just learned the basics of Docusaurus and made some changes to the initial template.",
                    source: "@site/docs/test/tutorial-basics/congratulations.md",
                    sourceDirName: "test/tutorial-basics",
                    slug: "/test/tutorial-basics/congratulations",
                    permalink: "/docs/test/tutorial-basics/congratulations",
                    editUrl:
                        "https://github.com/re-do/re-po/edit/main/pkgs/docs/docs/test/tutorial-basics/congratulations.md",
                    tags: [],
                    version: "current",
                    sidebarPosition: 6,
                        ...
                        (0, a.kt)(
                            ...
                            (0, a.kt)(
                                ...
                                p(
                                    { parentName: "strong" },
                                    {
                                        href: "/docs/test/tutorial-extras/manage-docs-versions"
                                    }
                                ),
                                "versioning"
                            )
                        ...
                        (0, a.kt)(
                            ...
                            (0, a.kt)(
                                ...
                                p(
                                    { parentName: "strong" },
                                    {
                                        href: "/docs/test/tutorial-extras/translate-your-site"
                                    }
                                ),
                                "i18n"
                            )
