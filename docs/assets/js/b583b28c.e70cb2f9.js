    ...
    [782],
    {
        ...
        2010: (e, t, r) => {
            ...
            const d = { sidebar_position: 1 },
                m = "Create a Page",
                g = {
                    unversionedId: "test/tutorial-basics/create-a-page",
                    id: "test/tutorial-basics/create-a-page",
                    title: "Create a Page",
                    description:
                        "Add Markdown or React files to src/pages to create a standalone page:",
                    source: "@site/docs/test/tutorial-basics/create-a-page.md",
                    sourceDirName: "test/tutorial-basics",
                    slug: "/test/tutorial-basics/create-a-page",
                    permalink: "/docs/test/tutorial-basics/create-a-page",
                    editUrl:
                        "https://github.com/re-do/re-po/edit/main/pkgs/docs/docs/test/tutorial-basics/create-a-page.md",
                    tags: [],
                    version: "current",
                    sidebarPosition: 1,
