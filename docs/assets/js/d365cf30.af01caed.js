    ...
    [241],
    {
        ...
        6316: (e, t, r) => {
            ...
            const d = { sidebar_position: 5 },
                y = "Deploy your site",
                m = {
                    unversionedId: "state/tutorial-basics/deploy-your-site",
                    id: "state/tutorial-basics/deploy-your-site",
                    title: "Deploy your site",
                    description:
                        "Docusaurus is a static-site-generator (also called Jamstack).",
                    source: "@site/docs/state/tutorial-basics/deploy-your-site.md",
                    sourceDirName: "state/tutorial-basics",
                    slug: "/state/tutorial-basics/deploy-your-site",
                    permalink: "/docs/state/tutorial-basics/deploy-your-site",
                    editUrl:
                        "https://github.com/re-do/re-po/edit/main/pkgs/docs/docs/state/tutorial-basics/deploy-your-site.md",
                    tags: [],
                    version: "current",
                    sidebarPosition: 5,
