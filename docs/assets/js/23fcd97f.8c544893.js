            ...
            var l = r.createContext({}),
                ...
                p = r.forwardRef(function (e, t) {
                    var n = e.components,
                        ...
                        p = c(n),
                        m = a,
                        k = p["".concat(l, ".").concat(m)] || p[m] || d[m] || o
                    return n
                        ? r.createElement(
                              k,
                              s(s({ ref: t }, u), {}, { components: n })
                          )
                        : r.createElement(k, s({ ref: t }, u))
                })
            function m(e, t) {
                var n = arguments,
                    a = t && t.mdxType
        ...
        5346: (e, t, n) => {
            ...
            var r = n(6383),
                ...
                d = (e, t) => {
                    ...
                    if (i) for (var n of i(t)) c.call(t, n) && u(e, n, t[n])
                    return e
                }
            const p = { sidebar_position: 4 },
                m = "Markdown Features",
                k = {
                    unversionedId: "test/tutorial-basics/markdown-features",
                    id: "test/tutorial-basics/markdown-features",
                    title: "Markdown Features",
                    description:
                        "Docusaurus supports Markdown and a few additional features.",
                    source: "@site/docs/test/tutorial-basics/markdown-features.mdx",
                    sourceDirName: "test/tutorial-basics",
                    slug: "/test/tutorial-basics/markdown-features",
                    permalink: "/docs/test/tutorial-basics/markdown-features",
                    editUrl:
                        "https://github.com/re-do/re-po/edit/main/pkgs/docs/docs/test/tutorial-basics/markdown-features.mdx",
                    tags: [],
                    version: "current",
                    sidebarPosition: 4,
                    ...
                    next: {
                        ...
                        permalink: "/docs/test/tutorial-basics/deploy-your-site"
                    }
                },
                g = [
                    {
                ...
                h = ({ children: e, color: t }) =>
                    (0, r.kt)(
                        "span",
                        {
                            ...
                            onClick: () => {
                                alert(
                                    `You clicked the color ${t} with label ${e}`
                                )
                            }
                        },
                        e
            ...
            function b(e) {
                ...
                return (0, r.kt)(
                    "wrapper",
                    ((t = d(d({}, A), p)),
                    o(t, s({ components: u, mdxType: "MDXLayout" }))),
                    (0, r.kt)(
                        "h1",
                        d({}, { id: "markdown-features" }),
                        "Markdown Features"
                    ),
                    (0, r.kt)(
                        "p",
                    ...
                    (0, r.kt)(
                        "p",
                        null,
                        (0, r.kt)("strong", { parentName: "p" }, "Result:"),
                        " Let's see how to ",
                        (0, r.kt)(
                            "a",
                            d(
                                { parentName: "p" },
                                {
                                    href: "/docs/test/tutorial-basics/create-a-page"
                                }
                            ),
                            "Create a page"
                        ),
                        ...
                        (0, r.kt)(
                            ...
                            d(
                                { parentName: "pre" },
                                {
                                    ...
                                    metastring:
                                        'title="src/components/HelloDocusaurus.js"',
                                    title: '"src/components/HelloDocusaurus.js"'
                                }
                            ),
                    ...
                    (0, r.kt)(
                        ...
                        d(
                            ...
                            {
                                className:
                                    "admonition admonition-tip alert alert--success"
                            }
                        ),
                        (0, r.kt)(
                            "div",
                    ...
                    (0, r.kt)(
                        ...
                        d(
                            ...
                            {
                                className:
                                    "admonition admonition-danger alert alert--danger"
                            }
                        ),
                        (0, r.kt)(
                            "div",
                    ...
                    (0, r.kt)(
                        ...
                        " can make your documentation more ",
                        (0, r.kt)("strong", { parentName: "p" }, "interactive"),
                        " and allows using any ",
                        (0, r.kt)(
                            "strong",
                            { parentName: "p" },
                    ...
                    (0, r.kt)(
                        ...
                        (0, r.kt)(
                            h,
                            { color: "#25c2a0", mdxType: "Highlight" },
                            "Docusaurus green"
                        ),
                        " !"
                    ),
                    (0, r.kt)(
                        ...
                        (0, r.kt)(
                            h,
                            { color: "#1877F2", mdxType: "Highlight" },
                            "Facebook blue"
                        ),
                        " !"
                    )
