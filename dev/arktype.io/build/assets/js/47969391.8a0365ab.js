    ...
    [9343],
    {
        ...
        144: (e, n, t) => {
            ...
            var r = t(4250),
                ...
                c = {
                    unversionedId: "intro",
                    id: "version-1.0.9-alpha/intro",
                    title: "Intro",
                    description:
                        'replace(./dev/arktype.io/static,) |> replace({ type },{"{"} type {"}"}) --\x3e',
                    source: "@site/versioned_docs/version-1.0.9-alpha/index.mdx",
                    sourceDirName: ".",
                    slug: "/",
                    permalink: "/docs/",
                    draft: !1,
                    ...
                    sidebar: "sidebar",
                    next: { title: "Scopes", permalink: "/docs/scopes" }
                },
                d = {},
                m = [
                    {
                        value: "Install <sub><sub>\ud83d\udce6<code>4KB</code> gzipped, <code>0</code> dependencies</sub></sub>",
                        id: "install-4kb-gzipped-0-dependencies",
                        level: 2
                    },
                    {
