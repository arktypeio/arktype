...
This snippet will give you an idea of `@re-/type` syntax. Try messing around with the `user` definition below and see how the type hints help guide you in the right direction.
