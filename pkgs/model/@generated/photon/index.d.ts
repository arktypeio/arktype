...
export declare class Photon {
    ...
    readonly tags: TagDelegate;
    readonly selectors: SelectorDelegate;
    readonly steps: StepDelegate;
    readonly tests: TestDelegate;
...
declare type TagGetSelectPayload<S extends boolean | TagSelect> = S extends true ? Tag : S extends TagSelect ? {
    [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends TagScalars ? Tag[P] : P extends 'user' ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>> : P extends 'test' ? TestGetSelectPayload<ExtractTestSelectArgs<S[P]>> : never;
} : never;
declare type TagGetIncludePayload<S extends boolean | TagInclude> = S extends true ? Tag : S extends TagInclude ? {
    [P in CleanupNever<MergeTruthyValues<TagDefault, S>>]: P extends TagScalars ? Tag[P] : P extends 'user' ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>> : P extends 'test' ? TestGetIncludePayload<ExtractTestIncludeArgs<S[P]>> : never;
} : never;
...
export interface StepDelegate {
    ...
    findOne<T extends FindOneStepArgs>(args: Subset<T, FindOneStepArgs>): T extends FindOneStepArgsRequired ? 'Please either choose `select` or `include`' : T extends FindOneStepSelectArgs ? Promise<StepGetSelectPayload<ExtractFindOneStepSelectArgs<T>>> : T extends FindOneStepIncludeArgs ? Promise<StepGetIncludePayload<ExtractFindOneStepIncludeArgs<T>>> : StepClient<Step>;
...
export interface TestDelegate {
    ...
    findOne<T extends FindOneTestArgs>(args: Subset<T, FindOneTestArgs>): T extends FindOneTestArgsRequired ? 'Please either choose `select` or `include`' : T extends FindOneTestSelectArgs ? Promise<TestGetSelectPayload<ExtractFindOneTestSelectArgs<T>>> : T extends FindOneTestIncludeArgs ? Promise<TestGetIncludePayload<ExtractFindOneTestIncludeArgs<T>>> : TestClient<Test>;
