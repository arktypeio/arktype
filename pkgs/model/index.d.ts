...
interface NexusPrismaInputs {
  ...
  ordering: 'id' | 'css'
    ...
    steps: {
  filtering: 'id' | 'action' | 'value' | 'AND' | 'OR' | 'NOT' | 'selector' | 'test' | 'user'
  ordering: 'id' | 'action' | 'value'
}
    tests: {
  filtering: 'id' | 'name' | 'steps' | 'tags' | 'AND' | 'OR' | 'NOT' | 'user'
  ordering: 'id' | 'name'
}
    users: {
  filtering: 'id' | 'email' | 'password' | 'firstName' | 'lastName' | 'selectors' | 'steps' | 'tests' | 'tags' | 'AND' | 'OR' | 'NOT'
