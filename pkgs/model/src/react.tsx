...
export type CreateOneTestMutation = (
  { __typename?: 'Mutation' }
  & { createOneTest: (
    { __typename?: 'Test' }
    & Pick<Test, 'id' | 'name'>
 ...
 * });
 */
export function useSelectorQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<SelectorQuery, SelectorQueryVariables>) {
        return ApolloReactHooks.useQuery<SelectorQuery, SelectorQueryVariables>(SelectorDocument, baseOptions);
      }
export function useSelectorLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SelectorQuery, SelectorQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<SelectorQuery, SelectorQueryVariables>(SelectorDocument, baseOptions);
        }
export type SelectorQueryHookResult = ReturnType<typeof useSelectorQuery>;
export type SelectorLazyQueryHookResult = ReturnType<typeof useSelectorLazyQuery>;
export type SelectorQueryResult = ApolloReactCommon.QueryResult<SelectorQuery, SelectorQueryVariables>;
export const SelectorsDocument = gql`
    query selectors($after: Int, $before: Int, $first: Int, $last: Int, $skip: Int) {
  selectors(after: $after, before: $before, first: $first, last: $last, skip: $skip) {
    css
    id
  }
}
 ...
 * });
 */
export function useSelectorsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<SelectorsQuery, SelectorsQueryVariables>) {
        return ApolloReactHooks.useQuery<SelectorsQuery, SelectorsQueryVariables>(SelectorsDocument, baseOptions);
      }
export function useSelectorsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SelectorsQuery, SelectorsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<SelectorsQuery, SelectorsQueryVariables>(SelectorsDocument, baseOptions);
        }
...
export type SelectorsQueryResult = ApolloReactCommon.QueryResult<SelectorsQuery, SelectorsQueryVariables>;
 ...
 * });
 */
export function useStepQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<StepQuery, StepQueryVariables>) {
        return ApolloReactHooks.useQuery<StepQuery, StepQueryVariables>(StepDocument, baseOptions);
      }
export function useStepLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<StepQuery, StepQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<StepQuery, StepQueryVariables>(StepDocument, baseOptions);
        }
...
export type StepQueryResult = ApolloReactCommon.QueryResult<StepQuery, StepQueryVariables>;
export const StepsDocument = gql`
    query steps($after: Int, $before: Int, $first: Int, $last: Int, $skip: Int) {
  steps(after: $after, before: $before, first: $first, last: $last, skip: $skip) {
    action
    id
    selector {
      css
...
export const TagsDocument = gql`
  ...
  tags(after: $after, before: $before, first: $first, last: $last, skip: $skip) {
    id
    name
  }
}
...
export const TestsDocument = gql`
    query tests($after: Int, $before: Int, $first: Int, $last: Int, $skip: Int) {
  tests(after: $after, before: $before, first: $first, last: $last, skip: $skip) {
    id
    name
    steps {
      action
 ...
 * });
 */
export function useTestsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<TestsQuery, TestsQueryVariables>) {
        return ApolloReactHooks.useQuery<TestsQuery, TestsQueryVariables>(TestsDocument, baseOptions);
      }
export function useTestsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<TestsQuery, TestsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<TestsQuery, TestsQueryVariables>(TestsDocument, baseOptions);
        }
...
export type TestsQueryResult = ApolloReactCommon.QueryResult<TestsQuery, TestsQueryVariables>;
...
export const UsersDocument = gql`
    query users($after: Int, $before: Int, $first: Int, $last: Int, $skip: Int) {
  users(after: $after, before: $before, first: $first, last: $last, skip: $skip) {
    email
    first
    id
    last
...
export const CreateOneTestDocument = gql`
    mutation createOneTest($name: String!, $steps: [StepCreateWithoutUserCreateOnlyInput!], $tags: [TagCreateWithoutTestCreateOnlyInput!]) {
  createOneTest(data: {name: $name, steps: $steps, tags: $tags}) {
    ...
    `;
export type CreateOneTestMutationFn = ApolloReactCommon.MutationFunction<CreateOneTestMutation, CreateOneTestMutationVariables>;
 ...
 * });
 */
export function useCreateOneTestMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<CreateOneTestMutation, CreateOneTestMutationVariables>) {
        return ApolloReactHooks.useMutation<CreateOneTestMutation, CreateOneTestMutationVariables>(CreateOneTestDocument, baseOptions);
      }
export type CreateOneTestMutationHookResult = ReturnType<typeof useCreateOneTestMutation>;
export type CreateOneTestMutationResult = ApolloReactCommon.MutationResult<CreateOneTestMutation>;
export type CreateOneTestMutationOptions = ApolloReactCommon.BaseMutationOptions<CreateOneTestMutation, CreateOneTestMutationVariables>;
...
export const SignUpDocument = gql`
  ...
  signUp(data: {email: $email, first: $first, last: $last, password: $password})
}
    `;
