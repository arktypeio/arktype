...
declare type TagGetSelectPayload<S extends boolean | TagSelect> = S extends true
    ? Tag
    : S extends TagSelect
    ? {
          [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends TagScalars
              ? Tag[P]
              : P extends "user"
              ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>>
              : P extends "test"
              ? TestGetSelectPayload<ExtractTestSelectArgs<S[P]>> | null
              : never
      }
    : never
declare type TagGetIncludePayload<
    S extends boolean | TagInclude
> = S extends true
    ? Tag
    : S extends TagInclude
    ? {
          [P in CleanupNever<
              MergeTruthyValues<TagDefault, S>
          >]: P extends TagScalars
              ? Tag[P]
              : P extends "user"
              ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>>
              : P extends "test"
              ? TestGetIncludePayload<ExtractTestIncludeArgs<S[P]>> | null
              : never
      }
    : never
export interface TagDelegate {
    <T extends FindManyTagArgs>(
        args?: Subset<T, FindManyTagArgs>
    ): T extends FindManyTagArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyTagSelectArgs
        ? Promise<Array<TagGetSelectPayload<ExtractFindManyTagSelectArgs<T>>>>
        : T extends FindManyTagIncludeArgs
        ? Promise<Array<TagGetIncludePayload<ExtractFindManyTagIncludeArgs<T>>>>
        : Promise<Array<Tag>>
    findOne<T extends FindOneTagArgs>(
        args: Subset<T, FindOneTagArgs>
    ): T extends FindOneTagArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindOneTagSelectArgs
        ? Promise<TagGetSelectPayload<ExtractFindOneTagSelectArgs<T>> | null>
        : T extends FindOneTagIncludeArgs
        ? Promise<TagGetIncludePayload<ExtractFindOneTagIncludeArgs<T>> | null>
        : TagClient<Tag | null>
    ...
    ): T extends TagCreateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TagSelectCreateArgs
        ? Promise<TagGetSelectPayload<ExtractTagSelectCreateArgs<T>>>
        : T extends TagIncludeCreateArgs
        ? Promise<TagGetIncludePayload<ExtractTagIncludeCreateArgs<T>>>
        : TagClient<Tag>
    delete<T extends TagDeleteArgs>(
        args: Subset<T, TagDeleteArgs>
    ): T extends TagDeleteArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TagSelectDeleteArgs
        ? Promise<TagGetSelectPayload<ExtractTagSelectDeleteArgs<T>>>
        : T extends TagIncludeDeleteArgs
        ? Promise<TagGetIncludePayload<ExtractTagIncludeDeleteArgs<T>>>
        : TagClient<Tag>
    update<T extends TagUpdateArgs>(
        args: Subset<T, TagUpdateArgs>
    ): T extends TagUpdateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TagSelectUpdateArgs
        ? Promise<TagGetSelectPayload<ExtractTagSelectUpdateArgs<T>>>
        : T extends TagIncludeUpdateArgs
        ? Promise<TagGetIncludePayload<ExtractTagIncludeUpdateArgs<T>>>
        : TagClient<Tag>
    ...
    ): T extends TagUpsertArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TagSelectUpsertArgs
        ? Promise<TagGetSelectPayload<ExtractTagSelectUpsertArgs<T>>>
        : T extends TagIncludeUpsertArgs
        ? Promise<TagGetIncludePayload<ExtractTagIncludeUpsertArgs<T>>>
        : TagClient<Tag>
...
export declare class TagClient<T> implements Promise<T> {
    ...
    ): T extends FindOneUserArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends UserSelectArgs
        ? Promise<UserGetSelectPayload<ExtractUserSelectArgs<T>> | null>
        : T extends UserIncludeArgs
        ? Promise<UserGetIncludePayload<ExtractUserIncludeArgs<T>> | null>
        : UserClient<User | null>
    test<T extends TestArgs = {}>(
        args?: Subset<T, TestArgs>
    ): T extends FindOneTestArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TestSelectArgs
        ? Promise<TestGetSelectPayload<ExtractTestSelectArgs<T>> | null>
        : T extends TestIncludeArgs
        ? Promise<TestGetIncludePayload<ExtractTestIncludeArgs<T>> | null>
        : TestClient<Test | null>
...
export declare type ExtractFindOneTagSelectArgs<
    S extends undefined | boolean | FindOneTagSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneTagSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindOneTagIncludeArgs<
    S extends undefined | boolean | FindOneTagIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneTagIncludeArgs
    ? S["include"]
    : true
/**
 * Tag findMany
...
export declare type ExtractFindManyTagSelectArgs<
    S extends undefined | boolean | FindManyTagSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyTagSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindManyTagIncludeArgs<
    S extends undefined | boolean | FindManyTagIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyTagIncludeArgs
    ? S["include"]
    : true
/**
 * Tag create
...
export declare type ExtractTagSelectCreateArgs<
    S extends undefined | boolean | TagSelectCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagSelectCreateArgs
    ? S["select"]
    : true
export declare type ExtractTagIncludeCreateArgs<
    S extends undefined | boolean | TagIncludeCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagIncludeCreateArgs
    ? S["include"]
    : true
/**
 * Tag update
...
export declare type ExtractTagSelectUpdateArgs<
    S extends undefined | boolean | TagSelectUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagSelectUpdateArgs
    ? S["select"]
    : true
export declare type ExtractTagIncludeUpdateArgs<
    S extends undefined | boolean | TagIncludeUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagIncludeUpdateArgs
    ? S["include"]
    : true
/**
 * Tag updateMany
...
export declare type ExtractTagSelectUpsertArgs<
    S extends undefined | boolean | TagSelectUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagSelectUpsertArgs
    ? S["select"]
    : true
export declare type ExtractTagIncludeUpsertArgs<
    S extends undefined | boolean | TagIncludeUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagIncludeUpsertArgs
    ? S["include"]
    : true
/**
 * Tag delete
...
export declare type ExtractTagSelectDeleteArgs<
    S extends undefined | boolean | TagSelectDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagSelectDeleteArgs
    ? S["select"]
    : true
export declare type ExtractTagIncludeDeleteArgs<
    S extends undefined | boolean | TagIncludeDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagIncludeDeleteArgs
    ? S["include"]
    : true
/**
 * Tag deleteMany
...
export declare type ExtractTagSelectArgs<
    S extends undefined | boolean | TagSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagSelectArgs
    ? S["select"]
    : true
export declare type ExtractTagIncludeArgs<
    S extends undefined | boolean | TagIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TagIncludeArgs
    ? S["include"]
    : true
/**
 * Model Selector
...
declare type SelectorGetSelectPayload<
    S extends boolean | SelectorSelect
> = S extends true
    ? Selector
    : S extends SelectorSelect
    ? {
          [P in CleanupNever<
              MergeTruthyValues<{}, S>
          >]: P extends SelectorScalars
              ? Selector[P]
              : P extends "steps"
              ? Array<StepGetSelectPayload<ExtractFindManyStepSelectArgs<S[P]>>>
              : P extends "user"
              ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>> | null
              : never
      }
    : never
declare type SelectorGetIncludePayload<
    S extends boolean | SelectorInclude
> = S extends true
    ? Selector
    : S extends SelectorInclude
    ? {
          [P in CleanupNever<
              MergeTruthyValues<SelectorDefault, S>
          >]: P extends SelectorScalars
              ? Selector[P]
              : P extends "steps"
              ? Array<
                    StepGetIncludePayload<ExtractFindManyStepIncludeArgs<S[P]>>
                >
              : P extends "user"
              ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>> | null
              : never
      }
    : never
export interface SelectorDelegate {
    <T extends FindManySelectorArgs>(
        args?: Subset<T, FindManySelectorArgs>
    ): T extends FindManySelectorArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManySelectorSelectArgs
        ? Promise<
              Array<
                  SelectorGetSelectPayload<ExtractFindManySelectorSelectArgs<T>>
              >
          >
        : T extends FindManySelectorIncludeArgs
        ? Promise<
              Array<
                  SelectorGetIncludePayload<
                      ExtractFindManySelectorIncludeArgs<T>
                  >
              >
          >
        : Promise<Array<Selector>>
    findOne<T extends FindOneSelectorArgs>(
        args: Subset<T, FindOneSelectorArgs>
    ): T extends FindOneSelectorArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindOneSelectorSelectArgs
        ? Promise<SelectorGetSelectPayload<
              ExtractFindOneSelectorSelectArgs<T>
          > | null>
        : T extends FindOneSelectorIncludeArgs
        ? Promise<SelectorGetIncludePayload<
              ExtractFindOneSelectorIncludeArgs<T>
          > | null>
        : SelectorClient<Selector | null>
    findMany<T extends FindManySelectorArgs>(
        args?: Subset<T, FindManySelectorArgs>
    ): T extends FindManySelectorArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManySelectorSelectArgs
        ...
        ? Promise<
          ...
          >
        : Promise<Array<Selector>>
    create<T extends SelectorCreateArgs>(
        args: Subset<T, SelectorCreateArgs>
    ): T extends SelectorCreateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends SelectorSelectCreateArgs
        ? Promise<SelectorGetSelectPayload<ExtractSelectorSelectCreateArgs<T>>>
        : T extends SelectorIncludeCreateArgs
        ? Promise<
              SelectorGetIncludePayload<ExtractSelectorIncludeCreateArgs<T>>
          >
        : SelectorClient<Selector>
    delete<T extends SelectorDeleteArgs>(
        args: Subset<T, SelectorDeleteArgs>
    ): T extends SelectorDeleteArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends SelectorSelectDeleteArgs
        ? Promise<SelectorGetSelectPayload<ExtractSelectorSelectDeleteArgs<T>>>
        : T extends SelectorIncludeDeleteArgs
        ? Promise<
              SelectorGetIncludePayload<ExtractSelectorIncludeDeleteArgs<T>>
          >
        : SelectorClient<Selector>
    update<T extends SelectorUpdateArgs>(
        args: Subset<T, SelectorUpdateArgs>
    ): T extends SelectorUpdateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends SelectorSelectUpdateArgs
        ? Promise<SelectorGetSelectPayload<ExtractSelectorSelectUpdateArgs<T>>>
        : T extends SelectorIncludeUpdateArgs
        ? Promise<
              SelectorGetIncludePayload<ExtractSelectorIncludeUpdateArgs<T>>
          >
        : SelectorClient<Selector>
    deleteMany<T extends SelectorDeleteManyArgs>(
        args: Subset<T, SelectorDeleteManyArgs>
    ): Promise<BatchPayload>
    updateMany<T extends SelectorUpdateManyArgs>(
        args: Subset<T, SelectorUpdateManyArgs>
    ): Promise<BatchPayload>
    upsert<T extends SelectorUpsertArgs>(
        args: Subset<T, SelectorUpsertArgs>
    ): T extends SelectorUpsertArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends SelectorSelectUpsertArgs
        ? Promise<SelectorGetSelectPayload<ExtractSelectorSelectUpsertArgs<T>>>
        : T extends SelectorIncludeUpsertArgs
        ? Promise<
              SelectorGetIncludePayload<ExtractSelectorIncludeUpsertArgs<T>>
          >
        : SelectorClient<Selector>
    count(): Promise<number>
}
export declare class SelectorClient<T> implements Promise<T> {
    ...
    readonly [Symbol.toStringTag]: "PhotonPromise"
    steps<T extends FindManyStepArgs = {}>(
        args?: Subset<T, FindManyStepArgs>
    ): T extends FindManyStepArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyStepSelectArgs
        ? Promise<Array<StepGetSelectPayload<ExtractFindManyStepSelectArgs<T>>>>
        : T extends FindManyStepIncludeArgs
        ? Promise<
              Array<StepGetIncludePayload<ExtractFindManyStepIncludeArgs<T>>>
          >
        : Promise<Array<Step>>
    user<T extends UserArgs = {}>(
        args?: Subset<T, UserArgs>
...
export declare type ExtractFindOneSelectorSelectArgs<
    S extends undefined | boolean | FindOneSelectorSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneSelectorSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindOneSelectorIncludeArgs<
    S extends undefined | boolean | FindOneSelectorIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneSelectorIncludeArgs
    ? S["include"]
    : true
/**
 * Selector findMany
...
export declare type ExtractFindManySelectorSelectArgs<
    S extends undefined | boolean | FindManySelectorSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManySelectorSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindManySelectorIncludeArgs<
    S extends undefined | boolean | FindManySelectorIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManySelectorIncludeArgs
    ? S["include"]
    : true
/**
 * Selector create
...
export declare type ExtractSelectorSelectCreateArgs<
    S extends undefined | boolean | SelectorSelectCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorSelectCreateArgs
    ? S["select"]
    : true
export declare type ExtractSelectorIncludeCreateArgs<
    S extends undefined | boolean | SelectorIncludeCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorIncludeCreateArgs
    ? S["include"]
    : true
/**
 * Selector update
...
export declare type ExtractSelectorSelectUpdateArgs<
    S extends undefined | boolean | SelectorSelectUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorSelectUpdateArgs
    ? S["select"]
    : true
export declare type ExtractSelectorIncludeUpdateArgs<
    S extends undefined | boolean | SelectorIncludeUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorIncludeUpdateArgs
    ? S["include"]
    : true
/**
 * Selector updateMany
...
export declare type ExtractSelectorSelectUpsertArgs<
    S extends undefined | boolean | SelectorSelectUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorSelectUpsertArgs
    ? S["select"]
    : true
export declare type ExtractSelectorIncludeUpsertArgs<
    S extends undefined | boolean | SelectorIncludeUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorIncludeUpsertArgs
    ? S["include"]
    : true
/**
 * Selector delete
...
export declare type ExtractSelectorSelectDeleteArgs<
    S extends undefined | boolean | SelectorSelectDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorSelectDeleteArgs
    ? S["select"]
    : true
export declare type ExtractSelectorIncludeDeleteArgs<
    S extends undefined | boolean | SelectorIncludeDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorIncludeDeleteArgs
    ? S["include"]
    : true
/**
 * Selector deleteMany
...
export declare type ExtractSelectorSelectArgs<
    S extends undefined | boolean | SelectorSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorSelectArgs
    ? S["select"]
    : true
export declare type ExtractSelectorIncludeArgs<
    S extends undefined | boolean | SelectorIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends SelectorIncludeArgs
    ? S["include"]
    : true
/**
 * Model Step
...
declare type StepGetSelectPayload<
    S extends boolean | StepSelect
> = S extends true
    ? Step
    : S extends StepSelect
    ? {
          [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends StepScalars
              ? Step[P]
              : P extends "selector"
              ? SelectorGetSelectPayload<ExtractSelectorSelectArgs<S[P]>>
              : P extends "tests"
              ? Array<TestGetSelectPayload<ExtractFindManyTestSelectArgs<S[P]>>>
              : P extends "user"
              ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>> | null
              : never
      }
    : never
declare type StepGetIncludePayload<
    S extends boolean | StepInclude
> = S extends true
    ? Step
    : S extends StepInclude
    ? {
          [P in CleanupNever<
              MergeTruthyValues<StepDefault, S>
          >]: P extends StepScalars
              ? Step[P]
              : P extends "selector"
              ? SelectorGetIncludePayload<ExtractSelectorIncludeArgs<S[P]>>
              : P extends "tests"
              ? Array<
                    TestGetIncludePayload<ExtractFindManyTestIncludeArgs<S[P]>>
                >
              : P extends "user"
              ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>> | null
              : never
...
export interface StepDelegate {
    <T extends FindManyStepArgs>(
        ...
        ? Promise<
          ...
          >
        : Promise<Array<Step>>
    findOne<T extends FindOneStepArgs>(
        args: Subset<T, FindOneStepArgs>
    ): T extends FindOneStepArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindOneStepSelectArgs
        ? Promise<StepGetSelectPayload<ExtractFindOneStepSelectArgs<T>> | null>
        : T extends FindOneStepIncludeArgs
        ? Promise<StepGetIncludePayload<
              ExtractFindOneStepIncludeArgs<T>
          > | null>
        : StepClient<Step | null>
    findMany<T extends FindManyStepArgs>(
        args?: Subset<T, FindManyStepArgs>
    ): T extends FindManyStepArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyStepSelectArgs
    ...
    create<T extends StepCreateArgs>(
        args: Subset<T, StepCreateArgs>
    ): T extends StepCreateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends StepSelectCreateArgs
        ? Promise<StepGetSelectPayload<ExtractStepSelectCreateArgs<T>>>
        : T extends StepIncludeCreateArgs
        ? Promise<StepGetIncludePayload<ExtractStepIncludeCreateArgs<T>>>
        : StepClient<Step>
    delete<T extends StepDeleteArgs>(
        args: Subset<T, StepDeleteArgs>
    ): T extends StepDeleteArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends StepSelectDeleteArgs
        ? Promise<StepGetSelectPayload<ExtractStepSelectDeleteArgs<T>>>
        : T extends StepIncludeDeleteArgs
        ? Promise<StepGetIncludePayload<ExtractStepIncludeDeleteArgs<T>>>
        : StepClient<Step>
    update<T extends StepUpdateArgs>(
        args: Subset<T, StepUpdateArgs>
    ): T extends StepUpdateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends StepSelectUpdateArgs
        ? Promise<StepGetSelectPayload<ExtractStepSelectUpdateArgs<T>>>
        : T extends StepIncludeUpdateArgs
        ? Promise<StepGetIncludePayload<ExtractStepIncludeUpdateArgs<T>>>
        : StepClient<Step>
    deleteMany<T extends StepDeleteManyArgs>(
        args: Subset<T, StepDeleteManyArgs>
    ): Promise<BatchPayload>
    updateMany<T extends StepUpdateManyArgs>(
        args: Subset<T, StepUpdateManyArgs>
    ): Promise<BatchPayload>
    upsert<T extends StepUpsertArgs>(
        args: Subset<T, StepUpsertArgs>
    ): T extends StepUpsertArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends StepSelectUpsertArgs
        ? Promise<StepGetSelectPayload<ExtractStepSelectUpsertArgs<T>>>
        : T extends StepIncludeUpsertArgs
        ? Promise<StepGetIncludePayload<ExtractStepIncludeUpsertArgs<T>>>
        : StepClient<Step>
    count(): Promise<number>
}
export declare class StepClient<T> implements Promise<T> {
    ...
    readonly [Symbol.toStringTag]: "PhotonPromise"
    selector<T extends SelectorArgs = {}>(
        args?: Subset<T, SelectorArgs>
    ): T extends FindOneSelectorArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends SelectorSelectArgs
        ? Promise<SelectorGetSelectPayload<ExtractSelectorSelectArgs<T>> | null>
        : T extends SelectorIncludeArgs
        ? Promise<SelectorGetIncludePayload<
              ExtractSelectorIncludeArgs<T>
          > | null>
        : SelectorClient<Selector | null>
    tests<T extends FindManyTestArgs = {}>(
        args?: Subset<T, FindManyTestArgs>
    ): T extends FindManyTestArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyTestSelectArgs
        ? Promise<Array<TestGetSelectPayload<ExtractFindManyTestSelectArgs<T>>>>
        : T extends FindManyTestIncludeArgs
        ? Promise<
              Array<TestGetIncludePayload<ExtractFindManyTestIncludeArgs<T>>>
          >
        : Promise<Array<Test>>
    user<T extends UserArgs = {}>(
        args?: Subset<T, UserArgs>
...
export declare type ExtractFindOneStepSelectArgs<
    S extends undefined | boolean | FindOneStepSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneStepSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindOneStepIncludeArgs<
    S extends undefined | boolean | FindOneStepIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneStepIncludeArgs
    ? S["include"]
    : true
/**
 * Step findMany
...
export declare type ExtractFindManyStepSelectArgs<
    S extends undefined | boolean | FindManyStepSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyStepSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindManyStepIncludeArgs<
    S extends undefined | boolean | FindManyStepIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyStepIncludeArgs
    ? S["include"]
    : true
/**
 * Step create
...
export declare type ExtractStepSelectCreateArgs<
    S extends undefined | boolean | StepSelectCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepSelectCreateArgs
    ? S["select"]
    : true
export declare type ExtractStepIncludeCreateArgs<
    S extends undefined | boolean | StepIncludeCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepIncludeCreateArgs
    ? S["include"]
    : true
/**
 * Step update
...
export declare type ExtractStepSelectUpdateArgs<
    S extends undefined | boolean | StepSelectUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepSelectUpdateArgs
    ? S["select"]
    : true
export declare type ExtractStepIncludeUpdateArgs<
    S extends undefined | boolean | StepIncludeUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepIncludeUpdateArgs
    ? S["include"]
    : true
/**
 * Step updateMany
...
export declare type ExtractStepSelectUpsertArgs<
    S extends undefined | boolean | StepSelectUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepSelectUpsertArgs
    ? S["select"]
    : true
export declare type ExtractStepIncludeUpsertArgs<
    S extends undefined | boolean | StepIncludeUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepIncludeUpsertArgs
    ? S["include"]
    : true
/**
 * Step delete
...
export declare type ExtractStepSelectDeleteArgs<
    S extends undefined | boolean | StepSelectDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepSelectDeleteArgs
    ? S["select"]
    : true
export declare type ExtractStepIncludeDeleteArgs<
    S extends undefined | boolean | StepIncludeDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepIncludeDeleteArgs
    ? S["include"]
    : true
/**
 * Step deleteMany
...
export declare type ExtractStepSelectArgs<
    S extends undefined | boolean | StepSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepSelectArgs
    ? S["select"]
    : true
export declare type ExtractStepIncludeArgs<
    S extends undefined | boolean | StepIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends StepIncludeArgs
    ? S["include"]
    : true
/**
 * Model Test
...
declare type TestGetSelectPayload<
    S extends boolean | TestSelect
> = S extends true
    ? Test
    : S extends TestSelect
    ? {
          [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends TestScalars
              ? Test[P]
              : P extends "user"
              ? UserGetSelectPayload<ExtractUserSelectArgs<S[P]>>
              : P extends "steps"
              ? Array<StepGetSelectPayload<ExtractFindManyStepSelectArgs<S[P]>>>
              : P extends "tags"
              ? Array<TagGetSelectPayload<ExtractFindManyTagSelectArgs<S[P]>>>
              : never
      }
    : never
declare type TestGetIncludePayload<
    S extends boolean | TestInclude
> = S extends true
    ? Test
    : S extends TestInclude
    ? {
          [P in CleanupNever<
              MergeTruthyValues<TestDefault, S>
          >]: P extends TestScalars
              ? Test[P]
              : P extends "user"
              ? UserGetIncludePayload<ExtractUserIncludeArgs<S[P]>>
              : P extends "steps"
              ? Array<
                ...
                >
              : P extends "tags"
              ? Array<TagGetIncludePayload<ExtractFindManyTagIncludeArgs<S[P]>>>
              : never
      }
    : never
export interface TestDelegate {
    <T extends FindManyTestArgs>(
        args?: Subset<T, FindManyTestArgs>
    ): T extends FindManyTestArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyTestSelectArgs
    ...
    findOne<T extends FindOneTestArgs>(
        ...
        ? "Please either choose `select` or `include`"
        : T extends FindOneTestSelectArgs
        ? Promise<TestGetSelectPayload<ExtractFindOneTestSelectArgs<T>> | null>
        : T extends FindOneTestIncludeArgs
        ? Promise<TestGetIncludePayload<
              ExtractFindOneTestIncludeArgs<T>
          > | null>
        : TestClient<Test | null>
    ...
    ): T extends TestCreateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TestSelectCreateArgs
        ? Promise<TestGetSelectPayload<ExtractTestSelectCreateArgs<T>>>
        : T extends TestIncludeCreateArgs
        ? Promise<TestGetIncludePayload<ExtractTestIncludeCreateArgs<T>>>
        : TestClient<Test>
    delete<T extends TestDeleteArgs>(
        args: Subset<T, TestDeleteArgs>
    ): T extends TestDeleteArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TestSelectDeleteArgs
        ? Promise<TestGetSelectPayload<ExtractTestSelectDeleteArgs<T>>>
        : T extends TestIncludeDeleteArgs
        ? Promise<TestGetIncludePayload<ExtractTestIncludeDeleteArgs<T>>>
        : TestClient<Test>
    update<T extends TestUpdateArgs>(
        args: Subset<T, TestUpdateArgs>
    ): T extends TestUpdateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TestSelectUpdateArgs
        ? Promise<TestGetSelectPayload<ExtractTestSelectUpdateArgs<T>>>
        : T extends TestIncludeUpdateArgs
        ? Promise<TestGetIncludePayload<ExtractTestIncludeUpdateArgs<T>>>
        : TestClient<Test>
    ...
    ): T extends TestUpsertArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends TestSelectUpsertArgs
        ? Promise<TestGetSelectPayload<ExtractTestSelectUpsertArgs<T>>>
        : T extends TestIncludeUpsertArgs
        ? Promise<TestGetIncludePayload<ExtractTestIncludeUpsertArgs<T>>>
        : TestClient<Test>
    count(): Promise<number>
}
export declare class TestClient<T> implements Promise<T> {
    ...
    steps<T extends FindManyStepArgs = {}>(
        ...
        ? Promise<
          ...
          >
        : Promise<Array<Step>>
    tags<T extends FindManyTagArgs = {}>(
        args?: Subset<T, FindManyTagArgs>
    ): T extends FindManyTagArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyTagSelectArgs
...
export declare type ExtractFindOneTestSelectArgs<
    S extends undefined | boolean | FindOneTestSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneTestSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindOneTestIncludeArgs<
    S extends undefined | boolean | FindOneTestIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindOneTestIncludeArgs
    ? S["include"]
    : true
/**
 * Test findMany
...
export declare type ExtractFindManyTestSelectArgs<
    S extends undefined | boolean | FindManyTestSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyTestSelectArgs
    ? S["select"]
    : true
export declare type ExtractFindManyTestIncludeArgs<
    S extends undefined | boolean | FindManyTestIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends FindManyTestIncludeArgs
    ? S["include"]
    : true
/**
 * Test create
...
export declare type ExtractTestSelectCreateArgs<
    S extends undefined | boolean | TestSelectCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestSelectCreateArgs
    ? S["select"]
    : true
export declare type ExtractTestIncludeCreateArgs<
    S extends undefined | boolean | TestIncludeCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestIncludeCreateArgs
    ? S["include"]
    : true
/**
 * Test update
...
export declare type ExtractTestSelectUpdateArgs<
    S extends undefined | boolean | TestSelectUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestSelectUpdateArgs
    ? S["select"]
    : true
export declare type ExtractTestIncludeUpdateArgs<
    S extends undefined | boolean | TestIncludeUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestIncludeUpdateArgs
    ? S["include"]
    : true
/**
 * Test updateMany
...
export declare type ExtractTestSelectUpsertArgs<
    S extends undefined | boolean | TestSelectUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestSelectUpsertArgs
    ? S["select"]
    : true
export declare type ExtractTestIncludeUpsertArgs<
    S extends undefined | boolean | TestIncludeUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestIncludeUpsertArgs
    ? S["include"]
    : true
/**
 * Test delete
...
export declare type ExtractTestSelectDeleteArgs<
    S extends undefined | boolean | TestSelectDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestSelectDeleteArgs
    ? S["select"]
    : true
export declare type ExtractTestIncludeDeleteArgs<
    S extends undefined | boolean | TestIncludeDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestIncludeDeleteArgs
    ? S["include"]
    : true
/**
 * Test deleteMany
...
export declare type ExtractTestSelectArgs<
    S extends undefined | boolean | TestSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestSelectArgs
    ? S["select"]
    : true
export declare type ExtractTestIncludeArgs<
    S extends undefined | boolean | TestIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    : S extends TestIncludeArgs
    ? S["include"]
    : true
/**
 * Model User
...
declare type UserGetSelectPayload<
    S extends boolean | UserSelect
> = S extends true
    ? User
          ...
          [P in CleanupNever<MergeTruthyValues<{}, S>>]: P extends UserScalars
              ...
              ? Array<
                    SelectorGetSelectPayload<
                        ExtractFindManySelectorSelectArgs<S[P]>
                    >
                >
              : P extends "tags"
              ? Array<TagGetSelectPayload<ExtractFindManyTagSelectArgs<S[P]>>>
    ...
    : never
declare type UserGetIncludePayload<
    S extends boolean | UserInclude
> = S extends true
    ? User
    : S extends UserInclude
    ? {
          [P in CleanupNever<
              MergeTruthyValues<UserDefault, S>
          >]: P extends UserScalars
              ? User[P]
              : P extends "steps"
              ? Array<
                    StepGetIncludePayload<ExtractFindManyStepIncludeArgs<S[P]>>
              ...
              ? Array<
                    SelectorGetIncludePayload<
                        ExtractFindManySelectorIncludeArgs<S[P]>
                    >
                >
              : P extends "tags"
              ? Array<TagGetIncludePayload<ExtractFindManyTagIncludeArgs<S[P]>>>
...
export interface UserDelegate {
    <T extends FindManyUserArgs>(
        args?: Subset<T, FindManyUserArgs>
    ): T extends FindManyUserArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManyUserSelectArgs
        ? Promise<Array<UserGetSelectPayload<ExtractFindManyUserSelectArgs<T>>>>
        : T extends FindManyUserIncludeArgs
        ? Promise<
              Array<UserGetIncludePayload<ExtractFindManyUserIncludeArgs<T>>>
          >
        : Promise<Array<User>>
    findOne<T extends FindOneUserArgs>(
        ...
        ? "Please either choose `select` or `include`"
        : T extends FindOneUserSelectArgs
        ? Promise<UserGetSelectPayload<ExtractFindOneUserSelectArgs<T>> | null>
        : T extends FindOneUserIncludeArgs
        ? Promise<UserGetIncludePayload<
              ExtractFindOneUserIncludeArgs<T>
          > | null>
        : UserClient<User | null>
    ...
    ): T extends UserCreateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends UserSelectCreateArgs
        ? Promise<UserGetSelectPayload<ExtractUserSelectCreateArgs<T>>>
        : T extends UserIncludeCreateArgs
        ? Promise<UserGetIncludePayload<ExtractUserIncludeCreateArgs<T>>>
        : UserClient<User>
    delete<T extends UserDeleteArgs>(
        args: Subset<T, UserDeleteArgs>
    ): T extends UserDeleteArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends UserSelectDeleteArgs
        ? Promise<UserGetSelectPayload<ExtractUserSelectDeleteArgs<T>>>
        : T extends UserIncludeDeleteArgs
        ? Promise<UserGetIncludePayload<ExtractUserIncludeDeleteArgs<T>>>
        : UserClient<User>
    update<T extends UserUpdateArgs>(
        args: Subset<T, UserUpdateArgs>
    ): T extends UserUpdateArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends UserSelectUpdateArgs
        ? Promise<UserGetSelectPayload<ExtractUserSelectUpdateArgs<T>>>
        : T extends UserIncludeUpdateArgs
        ? Promise<UserGetIncludePayload<ExtractUserIncludeUpdateArgs<T>>>
        : UserClient<User>
    ...
    ): T extends UserUpsertArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends UserSelectUpsertArgs
        ? Promise<UserGetSelectPayload<ExtractUserSelectUpsertArgs<T>>>
        : T extends UserIncludeUpsertArgs
        ? Promise<UserGetIncludePayload<ExtractUserIncludeUpsertArgs<T>>>
        : UserClient<User>
    count(): Promise<number>
}
export declare class UserClient<T> implements Promise<T> {
    ...
    steps<T extends FindManyStepArgs = {}>(
        ...
        ? Promise<
          ...
          >
        : Promise<Array<Step>>
    selectors<T extends FindManySelectorArgs = {}>(
        args?: Subset<T, FindManySelectorArgs>
    ): T extends FindManySelectorArgsRequired
        ? "Please either choose `select` or `include`"
        : T extends FindManySelectorSelectArgs
...
export declare type ExtractFindOneUserSelectArgs<
    S extends undefined | boolean | FindOneUserSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractFindOneUserIncludeArgs<
    S extends undefined | boolean | FindOneUserIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractFindManyUserSelectArgs<
    S extends undefined | boolean | FindManyUserSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractFindManyUserIncludeArgs<
    S extends undefined | boolean | FindManyUserIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractUserSelectCreateArgs<
    S extends undefined | boolean | UserSelectCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractUserIncludeCreateArgs<
    S extends undefined | boolean | UserIncludeCreateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractUserSelectUpdateArgs<
    S extends undefined | boolean | UserSelectUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractUserIncludeUpdateArgs<
    S extends undefined | boolean | UserIncludeUpdateArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractUserSelectUpsertArgs<
    S extends undefined | boolean | UserSelectUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractUserIncludeUpsertArgs<
    S extends undefined | boolean | UserIncludeUpsertArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractUserSelectDeleteArgs<
    S extends undefined | boolean | UserSelectDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractUserIncludeDeleteArgs<
    S extends undefined | boolean | UserIncludeDeleteArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
...
export declare type ExtractUserSelectArgs<
    S extends undefined | boolean | UserSelectArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
    ...
    ? S["select"]
    : true
export declare type ExtractUserIncludeArgs<
    S extends undefined | boolean | UserIncludeArgsOptional
> = S extends undefined
    ? false
    : S extends boolean
    ? S
