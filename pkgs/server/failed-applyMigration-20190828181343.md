...
```json
{
  ...
  "params": {
    "projectInfo": "",
    "force": false,
    "migrationId": "20190828181341-init",
    "steps": [
      {
        "stepType": "CreateModel",
        "name": "User",
...
stack backtrace:
   0: backtrace::backtrace::trace::h33eb18a9548cdf19 (0x105fbd3be)
   1: backtrace::capture::Backtrace::new_unresolved::hbe15ca481078b281 (0x105fbb5e8)
   2: failure::backtrace::internal::InternalBacktrace::new::h677d3f07444347de (0x105fbaf89)
   3: <failure::backtrace::Backtrace as core::default::Default>::default::hcac8ae7a11909b53 (0x105fbb175)
   4: prisma_query::connector::mysql::error::<impl core::convert::From<mysql::error::Error> for prisma_query::error::Error>::from::h4a98863bb78237aa (0x105b02a7e)
   5: prisma_query::connector::mysql::Mysql::new::h879da2362c716fdf (0x105ad3de4)
   6: sql_migration_connector::migration_database::Mysql::new::hb67f640d2db3c811 (0x105a42bed)
   7: sql_migration_connector::PrismaMysqlConfig::root_connection::h7c93452caf4cb02c (0x1059ff9a4)
   8: sql_migration_connector::SqlMigrationConnector::mysql_helper::hc87012de252fcdd6 (0x1059feb3e)
   9: sql_migration_connector::SqlMigrationConnector::new::hd2da02b872ee4ffd (0x1059fdac6)
  10: migration_core::connector_loader::load_connector::hc7e110cf6c938678 (0x10594456c)
  11: migration_core::migration_engine::MigrationEngine::init::hc1741e842ac3d246 (0x1059424e8)
  12: <F as jsonrpc_core::calls::RpcMethodSimple>::call::h7ba2d58a6db0262a (0x1059827b9)
  13: <F as jsonrpc_core::calls::RpcMethod<T>>::call::h566c3f9dc22a273f (0x10592e3cc)
  14: <futures::future::lazy::Lazy<F,R> as futures::future::Future>::poll::h1013e7386624a6ff (0x1059414f2)
  15: <futures::future::then::Then<A,B,F> as futures::future::Future>::poll::h7a5eb15e13aeeeb7 (0x10592ebb0)
  16: <futures::future::map::Map<A,F> as futures::future::Future>::poll::hcafae113f65ef0e3 (0x10594ae1f)
  17: <futures::future::either::Either<A,B> as futures::future::Future>::poll::hf2314b19ebcad874 (0x105941800)
  18: futures::task_impl::std::set::h770978995f72d15c (0x105979adf)
  19: std::thread::local::LocalKey<T>::with::h6be23f390bb8a5eb (0x10597d6e6)
  20: futures::future::Future::wait::h3f1c0c2a77f18093 (0x10594ab2f)
  21: jsonrpc_core::io::IoHandler<M>::handle_request_sync::h4d3d723b6feb431a (0x105928ecf)
  22: migration_core::rpc_api::RpcApi::handle::hf9fe4cc8e4df6876 (0x105989c5b)
  23: migration_engine::main::h984fc72fc0975d50 (0x10590556d)
  24: std::rt::lang_start::{{closure}}::h75401f289bc77adf (0x1059054a6)
  25: std::panicking::try::do_call::h1252fc9a2ff235eb (0x105fe18c8)
  26: __rust_maybe_catch_panic (0x105fe5caf)
  27: std::rt::lang_start_internal::h4c054360e442146c (0x105fe23ae)
  28: main (0x1059055c9))', src/libcore/result.rs:997:5
stack backtrace:
