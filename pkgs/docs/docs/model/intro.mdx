...
<div align="center">
  <img src="/img/logo.svg" width="400" alt="Redo Logo" />
  <h1>@re-/model</h1>
</div>
<div align="center">
...
2. Check out our [guide](https://github.com/re-do/re-po/blob/main/CONTRIBUTING.md) to get started!
...
[MIT license](https://github.com/re-do/re-po/blob/main/LICENSE).
