...
@arktype/type is a way to create universal types for your JS/TS values. From one definition, you get all the benefits of TypeScript in your editor and build and a validator like Yup or JOI at runtime.
...
```ts @blockFrom:@arktype/type/src/__snippets__/type.ts
...
```ts @blockFrom:@arktype/type/src/__snippets__/space.ts
import { space } from "@arktype/type"
...
```ts @blockFrom:@arktype/type/src/__snippets__/declaration/names.ts
import { declare } from "@arktype/type"
...
```ts @blockFrom:@arktype/type/src/__snippets__/declaration/declaration.ts
...
```ts @blockFrom:@arktype/type/src/__snippets__/declaration/user.ts
...
```ts @blockFrom:@arktype/type/src/__snippets__/declaration/group.ts
import { define } from "./names.js"
...
```ts @blockFrom:@arktype/type/src/__snippets__/constraints.ts
import { type } from "@arktype/type"
...
`@arktype/type` supports many of TypeScript's built-in types and operators, as well as some new ones dedicated exclusively to runtime validation. The following sections outline the kinds of definitions available to you when creating a type.
...
If you're interested in contributing to `@arktype/type`...
...
`@arktype/type` is part of a set of devtools designed to help you navigate the JS/TS ecosystem and get back to doing what you love. Learn more [at the root of this repo](https://github.com/arktypeio/arktype).
